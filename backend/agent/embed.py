    ...
    def _load_model(self):
        ...
        try:
            ...
            raise EmbedderUnavailable(
                "`fastembed` is not installed. It is in requirements.txt - run "
                "`pip install -r requirements.txt`. The dev profile uses "
                "Gemini instead, or set EMBEDDER=none for lexical-only."
            ) from exc
